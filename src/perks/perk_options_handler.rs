...
fn hash_to_perk_option_data(_hash: u32) -> Option<PerkOptionData> {
    ...
    match perk {
        //Meta perks
        Perks::BuiltIn => None,
        Perks::RallyBarricade => Some(PerkOptionData::toggled_on()),
        Perks::EmpRift => Some(PerkOptionData::toggled_on()),
        Perks::OnYourMark => Some(PerkOptionData::stacking(3)),
        Perks::Frequency => Some(PerkOptionData::toggled_on()),
        Perks::Tempering => Some(PerkOptionData::toggled_on()),
        Perks::Hedrons => Some(PerkOptionData::toggled_on()),
        Perks::HeatRises => Some(PerkOptionData::toggled_on()),
        Perks::FlowState => Some(PerkOptionData::toggled_on()),
        Perks::ThreadOfAscent => Some(PerkOptionData::toggled_on()),
        Perks::WellOfRadiance => Some(PerkOptionData::toggled_on()),
        Perks::Amplified => Some(PerkOptionData::toggled_on()),
        Perks::Radiant => Some(PerkOptionData::toggled_on()),
        Perks::Weaken => Some(PerkOptionData::toggled_on()),
        Perks::WardOfDawn => Some(PerkOptionData::toggled_on()),
        Perks::BannerShield => Some(PerkOptionData::toggled_on()),
        Perks::DeadFall => Some(PerkOptionData::toggled_on()),
        Perks::MoebiusQuiver => Some(PerkOptionData::toggled_on()),
        ...
        Perks::OphidianAspect => Some(PerkOptionData::toggled_on()),
        Perks::TomeOfDawn => Some(PerkOptionData::toggled_on()),
        Perks::PathOfTheBurningSteps => Some(PerkOptionData::stacking(4)),
        Perks::MantleOfBattleHarmony => Some(PerkOptionData::toggled_on()),
        Perks::MaskOfBakris => Some(PerkOptionData::toggled_on()),
        Perks::BallindorseWrathweavers => Some(PerkOptionData::toggled_on()),
        ...
        Perks::ActiumWarRig => Some(PerkOptionData::toggled_on()),
        Perks::HallowfireHeart => Some(PerkOptionData::toggled_on()),
        Perks::LionRampart => Some(PerkOptionData::toggled_on()),
        Perks::Peacekeepers => Some(PerkOptionData::toggled_on()),
        Perks::EyeOfAnotherWorld => Some(PerkOptionData::toggled_on()),
        Perks::AstrocyteVerse => Some(PerkOptionData::toggled_on()),
        Perks::NecroticGrips => Some(PerkOptionData::toggled_on()),
        ...
        Perks::Felwinters => Some(PerkOptionData::toggled_on()),
